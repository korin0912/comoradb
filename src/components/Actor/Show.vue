...
import actorImage10 from "../../assets/images/actor_10.png";
...
export default {
  ...
  data: function () {
    ...
    return {
      route: route,
      actorImages: [actorImage1, actorImage2, actorImage3, actorImage4, actorImage5, actorImage6, actorImage7, actorImage8, actorImage9, actorImage10],
